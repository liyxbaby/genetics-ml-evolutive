...
3. **Evolution at Work** Each Specimen in a generation is a mutation from the generation's base Specimen. If from a generation, the best fitted Specimen is less fitted than the previous one